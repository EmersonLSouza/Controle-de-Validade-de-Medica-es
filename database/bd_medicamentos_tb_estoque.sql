...
--
-- Host: localhost    Database: bd_medicamentos
-- ------------------------------------------------------
...
CREATE TABLE `tb_estoque` (
  ...
  `lote_medicamento` varchar(50) NOT NULL,
  `dt_vencimento` date NOT NULL,
  `qt_medicamento` int NOT NULL,
  `fk_id_medicamento` int DEFAULT NULL,
  PRIMARY KEY (`id_estoque`),
  KEY `fk_id_medicamento` (`fk_id_medicamento`),
  CONSTRAINT `tb_estoque_ibfk_1` FOREIGN KEY (`fk_id_medicamento`) REFERENCES `tb_medicamento` (`id_medicamento`)
...
-- Dump completed on 2026-05-21 23:18:44
